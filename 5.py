...
with open('connectio.log', 'r') as f:
  # Create a PrettyTable object to store the extracted information
  table = PrettyTable()
  table.field_names = ["Date", "Time", "IP", "URL", "Connection", "Bytes", "Packets", "Duration"]
  ...
  for line in f:
    ...
    table.add_row([date, time, ip, url, connection, bytes, packets, duration])
